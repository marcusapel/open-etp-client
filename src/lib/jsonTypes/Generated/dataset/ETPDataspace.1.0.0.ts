...
//
//   const well = Convert.toETPDataspace(json);
//
...
export class Convert {
  ...
  public static wellToJson(value: ETPDataspace): string {
...
const typeMap: any = {
  ETPDataspace: o(
    [
      ...
      { json: "legal", js: "legal", typ: r("LegalMetaData") },
      {
        json: "meta",
        js: "meta",
        typ: u(undefined, a(r("FrameOfReferenceMetaDataItem")))
      },
  ...
  Data: o(
    [
      ...
      {
        json: "ResourceCurationStatus",
        js: "ResourceCurationStatus",
        typ: u(undefined, "")
      },
      {
        json: "ResourceHomeRegionID",
        js: "ResourceHomeRegionID",
        typ: u(undefined, "")
      },
      {
        json: "ResourceHostRegionIDs",
        js: "ResourceHostRegionIDs",
        typ: u(undefined, a(""))
      },
      {
        json: "ResourceLifecycleStatus",
        js: "ResourceLifecycleStatus",
        typ: u(undefined, "")
      },
      {
        json: "ResourceSecurityClassification",
        js: "ResourceSecurityClassification",
        typ: u(undefined, "")
      },
      { json: "Source", js: "Source", typ: u(undefined, "") },
      {
        json: "TechnicalAssuranceID",
        js: "TechnicalAssuranceID",
        typ: u(undefined, "")
      },
      {
        json: "DatasetProperties",
        js: "DatasetProperties",
        typ: r("DatasetProperties")
      },
      { json: "Description", js: "Description", typ: u(undefined, "") },
      {
        json: "EncodingFormatTypeID",
        js: "EncodingFormatTypeID",
        typ: u(undefined, "")
      },
      { json: "Endian", js: "Endian", typ: u(undefined, r("Endian")) },
      { json: "Name", js: "Name", typ: u(undefined, "") },
      {
        json: "SchemaFormatTypeID",
        js: "SchemaFormatTypeID",
        typ: u(undefined, "")
      },
  ...
  LegalMetaData: o(
    [
      ...
      {
        json: "otherRelevantDataCountries",
        js: "otherRelevantDataCountries",
        typ: a("")
      },
  ...
  FrameOfReferenceMetaDataItem: o(
    [
      ...
      {
        json: "coordinateReferenceSystemID",
        js: "coordinateReferenceSystemID",
        typ: u(undefined, "")
      }
    ],
    "any"
