// To parse this data:
//
//   import { Convert, AbstractInterpretation } from "./file";
//
//   const abstractInterpretation = Convert.toAbstractInterpretation(json);
//
...
export class Convert {
    public static toAbstractInterpretation(json: string): AbstractInterpretation {
        return cast(JSON.parse(json), r("AbstractInterpretation"));
    }

    public static abstractInterpretationToJson(value: AbstractInterpretation): string {
        return JSON.stringify(uncast(value, r("AbstractInterpretation")), null, 2);
    }
}
