// To parse this data:
//
//   import { Convert, RepresentationRole } from "./file";
//
//   const representationRole = Convert.toRepresentationRole(json);
//
...
export class Convert {
    public static toRepresentationRole(json: string): RepresentationRole {
        return cast(JSON.parse(json), r("RepresentationRole"));
    }

    public static representationRoleToJson(value: RepresentationRole): string {
        return JSON.stringify(uncast(value, r("RepresentationRole")), null, 2);
    }
}
