// To parse this data:
//
//   import { Convert, PropertyType } from "./file";
//
//   const propertyType = Convert.toPropertyType(json);
//
...
export class Convert {
    public static toPropertyType(json: string): PropertyType {
        return cast(JSON.parse(json), r("PropertyType"));
    }

    public static propertyTypeToJson(value: PropertyType): string {
        return JSON.stringify(uncast(value, r("PropertyType")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Data": o([
        ...
        { json: "ParentPropertyTypeID", js: "ParentPropertyTypeID", typ: "" },
        { json: "UnitQuantityID", js: "UnitQuantityID", typ: "" },
