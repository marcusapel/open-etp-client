// To parse this data:
//
//   import { Convert, ParameterKind } from "./file";
//
//   const parameterKind = Convert.toParameterKind(json);
//
...
export class Convert {
    public static toParameterKind(json: string): ParameterKind {
        return cast(JSON.parse(json), r("ParameterKind"));
    }

    public static parameterKindToJson(value: ParameterKind): string {
        return JSON.stringify(uncast(value, r("ParameterKind")), null, 2);
    }
}
