// To parse this data:
//
//   import { Convert, KDirectionType } from "./file";
//
//   const kDirectionType = Convert.toKDirectionType(json);
//
 ...
 * monotonic.
 */
export interface KDirectionType {
    /**
...
export class Convert {
    public static toKDirectionType(json: string): KDirectionType {
        return cast(JSON.parse(json), r("KDirectionType"));
    }

    public static kDirectionTypeToJson(value: KDirectionType): string {
        return JSON.stringify(uncast(value, r("KDirectionType")), null, 2);
    }
}
