// To parse this data:
//
//   import { Convert, PillarShapeType } from "./file";
//
//   const pillarShapeType = Convert.toPillarShapeType(json);
//
 ...
 * straight, curved.
 */
export interface PillarShapeType {
    /**
...
export class Convert {
    public static toPillarShapeType(json: string): PillarShapeType {
        return cast(JSON.parse(json), r("PillarShapeType"));
    }

    public static pillarShapeTypeToJson(value: PillarShapeType): string {
        return JSON.stringify(uncast(value, r("PillarShapeType")), null, 2);
    }
}
