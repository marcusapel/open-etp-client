// To parse this data:
//
//   import { Convert, RepresentationType } from "./file";
//
//   const representationType = Convert.toRepresentationType(json);
//
...
export class Convert {
    public static toRepresentationType(json: string): RepresentationType {
        return cast(JSON.parse(json), r("RepresentationType"));
    }

    public static representationTypeToJson(value: RepresentationType): string {
        return JSON.stringify(uncast(value, r("RepresentationType")), null, 2);
    }
}
