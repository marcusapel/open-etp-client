// To parse this data:
//
//   import { Convert, ColumnBasedTableType } from "./file";
//
//   const columnBasedTableType = Convert.toColumnBasedTableType(json);
//
 ...
 * based table types.
 */
export interface ColumnBasedTableType {
    /**
...
export class Convert {
    public static toColumnBasedTableType(json: string): ColumnBasedTableType {
        return cast(JSON.parse(json), r("ColumnBasedTableType"));
    }

    public static columnBasedTableTypeToJson(value: ColumnBasedTableType): string {
        return JSON.stringify(uncast(value, r("ColumnBasedTableType")), null, 2);
    }
}
