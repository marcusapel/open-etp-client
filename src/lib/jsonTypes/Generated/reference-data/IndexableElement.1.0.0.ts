// To parse this data:
//
//   import { Convert, IndexableElement } from "./file";
//
//   const indexableElement = Convert.toIndexableElement(json);
//
...
export class Convert {
    public static toIndexableElement(json: string): IndexableElement {
        return cast(JSON.parse(json), r("IndexableElement"));
    }

    public static indexableElementToJson(value: IndexableElement): string {
        return JSON.stringify(uncast(value, r("IndexableElement")), null, 2);
    }
}
