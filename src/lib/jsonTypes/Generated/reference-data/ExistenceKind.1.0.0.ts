// To parse this data:
//
//   import { Convert, ExistenceKind } from "./file";
//
//   const existenceKind = Convert.toExistenceKind(json);
//
 ...
 * Disposal".
 */
export interface ExistenceKind {
    /**
...
export class Convert {
    public static toExistenceKind(json: string): ExistenceKind {
        return cast(JSON.parse(json), r("ExistenceKind"));
    }

    public static existenceKindToJson(value: ExistenceKind): string {
        return JSON.stringify(uncast(value, r("ExistenceKind")), null, 2);
    }
}
