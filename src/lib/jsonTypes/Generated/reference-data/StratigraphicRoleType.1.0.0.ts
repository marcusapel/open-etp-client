// To parse this data:
//
//   import { Convert, StratigraphicRoleType } from "./file";
//
//   const stratigraphicRoleType = Convert.toStratigraphicRoleType(json);
//
 ...
 */
export interface StratigraphicRoleType {
    /**
...
export class Convert {
    public static toStratigraphicRoleType(json: string): StratigraphicRoleType {
        return cast(JSON.parse(json), r("StratigraphicRoleType"));
    }

    public static stratigraphicRoleTypeToJson(value: StratigraphicRoleType): string {
        return JSON.stringify(uncast(value, r("StratigraphicRoleType")), null, 2);
    }
}
