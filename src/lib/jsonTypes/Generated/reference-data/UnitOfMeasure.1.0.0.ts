// To parse this data:
//
//   import { Convert, UnitOfMeasure } from "./file";
//
//   const unitOfMeasure = Convert.toUnitOfMeasure(json);
//
...
export class Convert {
    public static toUnitOfMeasure(json: string): UnitOfMeasure {
        return cast(JSON.parse(json), r("UnitOfMeasure"));
    }

    public static unitOfMeasureToJson(value: UnitOfMeasure): string {
        return JSON.stringify(uncast(value, r("UnitOfMeasure")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Data": o([
        ...
        { json: "CoefficientA", js: "CoefficientA", typ: u(undefined, 3.14) },
        { json: "CoefficientB", js: "CoefficientB", typ: u(undefined, 3.14) },
        { json: "CoefficientC", js: "CoefficientC", typ: u(undefined, 3.14) },
        { json: "CoefficientD", js: "CoefficientD", typ: u(undefined, 3.14) },
        { json: "IsBaseUnit", js: "IsBaseUnit", typ: u(undefined, true) },
        { json: "PersistableReference", js: "PersistableReference", typ: u(undefined, "") },
        { json: "UnitDimensionCode", js: "UnitDimensionCode", typ: u(undefined, "") },
        { json: "UnitDimensionName", js: "UnitDimensionName", typ: u(undefined, "") },
