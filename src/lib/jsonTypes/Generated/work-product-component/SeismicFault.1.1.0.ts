// To parse this data:
//
//   import { Convert, SeismicFault } from "./file";
//
//   const seismicFault = Convert.toSeismicFault(json);
//
...
export interface Data {
     ...
     */
    FaultHeaveNumber?: number;
    /**
     * Net (average) Slip.
     */
    FaultNetSlipNumber?: number;
    /**
     ...
     */
    SeismicTraceDataIDs?: string[];
    /**
     * Maximum vertical offset of faulted strata.
     */
    StratigraphicFaultOffset?: number;
    /**
     * The FaultSystem RepresentationType assigned to this SeismicFault. Examples: PolylineSet,
     * TriangulatedSurface.
     */
    Type?: string;
    /**
...
export class Convert {
    public static toSeismicFault(json: string): SeismicFault {
        return cast(JSON.parse(json), r("SeismicFault"));
    }

    public static seismicFaultToJson(value: SeismicFault): string {
        return JSON.stringify(uncast(value, r("SeismicFault")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Data": o([
        ...
        { json: "FaultHeaveNumber", js: "FaultHeaveNumber", typ: u(undefined, 3.14) },
        { json: "FaultNetSlipNumber", js: "FaultNetSlipNumber", typ: u(undefined, 3.14) },
        ...
        { json: "SeismicFaultLength", js: "SeismicFaultLength", typ: u(undefined, 3.14) },
        { json: "SeismicFaultSurfaceArea", js: "SeismicFaultSurfaceArea", typ: u(undefined, 3.14) },
        { json: "SeismicFaultTypeID", js: "SeismicFaultTypeID", typ: u(undefined, "") },
        ...
        { json: "SeismicTraceDataIDs", js: "SeismicTraceDataIDs", typ: u(undefined, a("")) },
        { json: "StratigraphicFaultOffset", js: "StratigraphicFaultOffset", typ: u(undefined, 3.14) },
        { json: "Type", js: "Type", typ: u(undefined, "") },
        { json: "VerticalDatumOffset", js: "VerticalDatumOffset", typ: u(undefined, 3.14) },
        { json: "VerticalFaultDipAngle", js: "VerticalFaultDipAngle", typ: u(undefined, 3.14) },
