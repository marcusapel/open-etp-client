// To parse this data:
//
//   import { Convert, LocalRockVolumeFeature } from "./file";
//
//   const localRockVolumeFeature = Convert.toLocalRockVolumeFeature(json);
//
 ...
 */
export interface LocalRockVolumeFeature {
    /**
...
export class Convert {
    public static toLocalRockVolumeFeature(json: string): LocalRockVolumeFeature {
        return cast(JSON.parse(json), r("LocalRockVolumeFeature"));
    }

    public static localRockVolumeFeatureToJson(value: LocalRockVolumeFeature): string {
        return JSON.stringify(uncast(value, r("LocalRockVolumeFeature")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Data": o([
        ...
        { json: "RockVolumeFeatureID", js: "RockVolumeFeatureID", typ: u(undefined, "") },
