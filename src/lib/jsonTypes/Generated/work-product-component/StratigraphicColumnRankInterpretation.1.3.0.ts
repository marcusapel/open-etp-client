// To parse this data:
//
//   import { Convert, StratigraphicColumnRankInterpretation } from "./file";
//
//   const stratigraphicColumnRankInterpretation = Convert.toStratigraphicColumnRankInterpretation(json);
//
...
export interface Data {
     ...
     */
    StratigraphicUnitInterpretationSet?: string[];
...
export class Convert {
    public static toStratigraphicColumnRankInterpretation(json: string): StratigraphicColumnRankInterpretation {
        return cast(JSON.parse(json), r("StratigraphicColumnRankInterpretation"));
    }

    public static stratigraphicColumnRankInterpretationToJson(value: StratigraphicColumnRankInterpretation): string {
        return JSON.stringify(uncast(value, r("StratigraphicColumnRankInterpretation")), null, 2);
    }
}
...
const typeMap: any = {
    "StratigraphicColumnRankInterpretation": o([
    ...
    "Data": o([
        ...
        { json: "ChronoStratigraphySet", js: "ChronoStratigraphySet", typ: u(undefined, a("")) },
        { json: "SequenceStratigraphicSchemaType", js: "SequenceStratigraphicSchemaType", typ: u(undefined, "") },
        { json: "StratigraphicColumnRankUnitType", js: "StratigraphicColumnRankUnitType", typ: u(undefined, "") },
        { json: "StratigraphicRoleType", js: "StratigraphicRoleType", typ: u(undefined, "") },
        { json: "StratigraphicUnitInterpretationSet", js: "StratigraphicUnitInterpretationSet", typ: u(undefined, a("")) },
