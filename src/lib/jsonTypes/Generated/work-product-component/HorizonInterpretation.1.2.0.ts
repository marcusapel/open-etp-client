// To parse this data:
//
//   import { Convert, HorizonInterpretation } from "./file";
//
//   const horizonInterpretation = Convert.toHorizonInterpretation(json);
//
 ...
 * modeled objects etc…)
 */
export interface HorizonInterpretation {
    /**
...
export interface Data {
     ...
     */
    SequenceStratigraphySurfaceTypeID?: string;
    /**
...
export class Convert {
    public static toHorizonInterpretation(json: string): HorizonInterpretation {
        return cast(JSON.parse(json), r("HorizonInterpretation"));
    }

    public static horizonInterpretationToJson(value: HorizonInterpretation): string {
        return JSON.stringify(uncast(value, r("HorizonInterpretation")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Data": o([
        ...
        { json: "isConformableAbove", js: "isConformableAbove", typ: u(undefined, true) },
        { json: "isConformableBelow", js: "isConformableBelow", typ: u(undefined, true) },
        { json: "SequenceStratigraphySurfaceTypeID", js: "SequenceStratigraphySurfaceTypeID", typ: u(undefined, "") },
