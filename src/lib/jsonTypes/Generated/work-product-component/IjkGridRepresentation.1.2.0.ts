// To parse this data:
//
//   import { Convert, IjkGridRepresentation } from "./file";
//
//   const ijkGridRepresentation = Convert.toIjkGridRepresentation(json);
//
 ...
 */
export interface IjkGridRepresentation {
    /**
...
export interface Abstract {
     ...
     */
    HasFiniteElementSubnodes?: boolean;
    /**
     ...
     */
    RockFluidOrganizationInterpretationIDS?: string[];
    /**
     ...
     */
    ExpansionInDirection?: ExpansionInDirection;
    /**
     ...
     */
    HasCollocatedNodeInKDirection?: boolean;
    /**
 ...
 * expansion, J expansion, I expansion)
 */
export enum ExpansionInDirection {
    I = "I",
    J = "J",
    K = "K",
}
 ...
 * stratigraphic organization.
 */
export interface StratigraphicUnits {
    /**
     ...
     */
    StratigraphicUnitsIndices: Array<number[]>;
}
...
export class Convert {
    public static toIjkGridRepresentation(json: string): IjkGridRepresentation {
        return cast(JSON.parse(json), r("IjkGridRepresentation"));
    }

    public static ijkGridRepresentationToJson(value: IjkGridRepresentation): string {
        return JSON.stringify(uncast(value, r("IjkGridRepresentation")), null, 2);
    }
}
...
const typeMap: any = {
    "IjkGridRepresentation": o([
        ...
        { json: "data", js: "data", typ: u(undefined, r("Abstract")) },
    ...
    "Abstract": o([
        ...
        { json: "ActiveCellCount", js: "ActiveCellCount", typ: u(undefined, 0) },
        { json: "HasFiniteElementSubnodes", js: "HasFiniteElementSubnodes", typ: u(undefined, true) },
        { json: "HasNaNGeometry", js: "HasNaNGeometry", typ: u(undefined, true) },
        { json: "HasNoGeometry", js: "HasNoGeometry", typ: u(undefined, true) },
        { json: "ParentGridID", js: "ParentGridID", typ: u(undefined, "") },
        { json: "RockFluidOrganizationInterpretationIDS", js: "RockFluidOrganizationInterpretationIDS", typ: u(undefined, a("")) },
        { json: "StratigraphicUnits", js: "StratigraphicUnits", typ: u(undefined, r("StratigraphicUnits")) },
        { json: "ExpansionInDirection", js: "ExpansionInDirection", typ: u(undefined, r("ExpansionInDirection")) },
        { json: "HasCollocatedNodeInKDirection", js: "HasCollocatedNodeInKDirection", typ: u(undefined, true) },
        { json: "HasKGaps", js: "HasKGaps", typ: u(undefined, true) },
        { json: "HasLateralGaps", js: "HasLateralGaps", typ: u(undefined, true) },
        { json: "HasParametricGeometry", js: "HasParametricGeometry", typ: u(undefined, true) },
        { json: "HasSplitNode", js: "HasSplitNode", typ: u(undefined, true) },
        { json: "HasTruncations", js: "HasTruncations", typ: u(undefined, true) },
        { json: "KDirectionID", js: "KDirectionID", typ: u(undefined, "") },
        { json: "Nk", js: "Nk", typ: u(undefined, 0) },
        { json: "PillarShapeID", js: "PillarShapeID", typ: u(undefined, "") },
        { json: "IsRadial", js: "IsRadial", typ: u(undefined, true) },
        { json: "IsRightHanded", js: "IsRightHanded", typ: u(undefined, true) },
        { json: "Ni", js: "Ni", typ: u(undefined, 0) },
        { json: "Nj", js: "Nj", typ: u(undefined, 0) },
    ...
    "StratigraphicUnits": o([
        { json: "StratigraphicColumnRankInterpretationID", js: "StratigraphicColumnRankInterpretationID", typ: "" },
        { json: "StratigraphicUnitsIndices", js: "StratigraphicUnitsIndices", typ: a(a(0)) },
    ], "any"),
