// To parse this data:
//
//   import { Convert, LocalBoundaryFeature } from "./file";
//
//   const localBoundaryFeature = Convert.toLocalBoundaryFeature(json);
//
 ...
 */
export interface LocalBoundaryFeature {
    /**
...
export class Convert {
    public static toLocalBoundaryFeature(json: string): LocalBoundaryFeature {
        return cast(JSON.parse(json), r("LocalBoundaryFeature"));
    }

    public static localBoundaryFeatureToJson(value: LocalBoundaryFeature): string {
        return JSON.stringify(uncast(value, r("LocalBoundaryFeature")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Data": o([
        ...
        { json: "BoundaryFeatureID", js: "BoundaryFeatureID", typ: u(undefined, "") },
