// To parse this data:
//
//   import { Convert, GenericProperty } from "./file";
//
//   const genericProperty = Convert.toGenericProperty(json);
//
...
export class Convert {
    public static toGenericProperty(json: string): GenericProperty {
        return cast(JSON.parse(json), r("GenericProperty"));
    }

    public static genericPropertyToJson(value: GenericProperty): string {
        return JSON.stringify(uncast(value, r("GenericProperty")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Data": o([
        ...
        { json: "ClassificationTableID", js: "ClassificationTableID", typ: u(undefined, "") },
        { json: "IndexableElementID", js: "IndexableElementID", typ: u(undefined, "") },
        { json: "MaxValue", js: "MaxValue", typ: u(undefined, 3.14) },
        { json: "MeanValue", js: "MeanValue", typ: u(undefined, 3.14) },
        { json: "MinValue", js: "MinValue", typ: u(undefined, 3.14) },
        { json: "PropertyTopologyID", js: "PropertyTopologyID", typ: u(undefined, "") },
        { json: "PropertyUnitID", js: "PropertyUnitID", typ: u(undefined, "") },
        { json: "RealizationIndices", js: "RealizationIndices", typ: u(undefined, a(3.14)) },
        { json: "StdDeviation", js: "StdDeviation", typ: u(undefined, 3.14) },
        { json: "TimeIndices", js: "TimeIndices", typ: u(undefined, 3.14) },
        { json: "TimeSeriesID", js: "TimeSeriesID", typ: u(undefined, "") },
        { json: "TimeValues", js: "TimeValues", typ: u(undefined, a("")) },
