// To parse this data:
//
//   import { Convert, SubRepresentation } from "./file";
//
//   const subRepresentation = Convert.toSubRepresentation(json);
//
...
export interface Data {
     ...
     * an IJK grid
     */
    NestedIndexableElementID?: string;
    /**
...
export class Convert {
    public static toSubRepresentation(json: string): SubRepresentation {
        return cast(JSON.parse(json), r("SubRepresentation"));
    }

    public static subRepresentationToJson(value: SubRepresentation): string {
        return JSON.stringify(uncast(value, r("SubRepresentation")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Data": o([
        ...
        { json: "NestedIndexableElementID", js: "NestedIndexableElementID", typ: u(undefined, "") },
        { json: "SupportingRepresentationIDs", js: "SupportingRepresentationIDs", typ: u(undefined, a("")) },
