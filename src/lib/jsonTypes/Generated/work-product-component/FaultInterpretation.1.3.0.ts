// To parse this data:
//
//   import { Convert, FaultInterpretation } from "./file";
//
//   const faultInterpretation = Convert.toFaultInterpretation(json);
//
...
export interface Data {
     ...
     */
    FaultThrowDescriptions?: FaultThrowDescriptions[];
    /**
 ...
 */
export interface FaultThrowDescriptions {
    /**
     * Specifies the fault throw type (reverse, normal etc…)
     */
    FaultThrowTypeID?: string;
    /**
 ...
 * Indicates the representative azimuth value of the fault plane
 */
export interface RepresentativeDIPDirection {
    /**
...
export class Convert {
    public static toFaultInterpretation(json: string): FaultInterpretation {
        return cast(JSON.parse(json), r("FaultInterpretation"));
    }

    public static faultInterpretationToJson(value: FaultInterpretation): string {
        return JSON.stringify(uncast(value, r("FaultInterpretation")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Data": o([
        ...
        { json: "FaultLength", js: "FaultLength", typ: u(undefined, 3.14) },
        { json: "FaultThrowDescriptions", js: "FaultThrowDescriptions", typ: u(undefined, a(r("FaultThrowDescriptions"))) },
        { json: "IsListric", js: "IsListric", typ: u(undefined, true) },
        { json: "IsSealed", js: "IsSealed", typ: u(undefined, true) },
        { json: "MaximumFaultStrikeSlip", js: "MaximumFaultStrikeSlip", typ: u(undefined, 3.14) },
        { json: "MaximumFaultThrowValue", js: "MaximumFaultThrowValue", typ: u(undefined, 3.14) },
        { json: "RepresentativeDipAngle", js: "RepresentativeDipAngle", typ: u(undefined, 3.14) },
        { json: "RepresentativeDipDirection", js: "RepresentativeDipDirection", typ: u(undefined, r("RepresentativeDIPDirection")) },
        { json: "SurfaceArea", js: "SurfaceArea", typ: u(undefined, 3.14) },
    ...
    "FaultThrowDescriptions": o([
        { json: "FaultThrowTypeID", js: "FaultThrowTypeID", typ: u(undefined, "") },
        { json: "MaximumAge", js: "MaximumAge", typ: u(undefined, 3.14) },
        { json: "MinimumAge", js: "MinimumAge", typ: u(undefined, 3.14) },
    ], "any"),
    ...
    "RepresentativeDIPDirection": o([
        { json: "NorthKind", js: "NorthKind", typ: u(undefined, "") },
