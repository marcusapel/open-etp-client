// To parse this data:
//
//   import { Convert, LocalModelFeature } from "./file";
//
//   const localModelFeature = Convert.toLocalModelFeature(json);
//
 ...
 */
export interface LocalModelFeature {
    /**
...
export class Convert {
    public static toLocalModelFeature(json: string): LocalModelFeature {
        return cast(JSON.parse(json), r("LocalModelFeature"));
    }

    public static localModelFeatureToJson(value: LocalModelFeature): string {
        return JSON.stringify(uncast(value, r("LocalModelFeature")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Data": o([
        ...
        { json: "ModelFeatureID", js: "ModelFeatureID", typ: u(undefined, "") },
