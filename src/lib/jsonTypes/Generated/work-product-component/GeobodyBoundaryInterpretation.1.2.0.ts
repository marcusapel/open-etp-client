// To parse this data:
//
//   import { Convert, GeobodyBoundaryInterpretation } from "./file";
//
//   const geobodyBoundaryInterpretation = Convert.toGeobodyBoundaryInterpretation(json);
//
...
export class Convert {
    public static toGeobodyBoundaryInterpretation(json: string): GeobodyBoundaryInterpretation {
        return cast(JSON.parse(json), r("GeobodyBoundaryInterpretation"));
    }

    public static geobodyBoundaryInterpretationToJson(value: GeobodyBoundaryInterpretation): string {
        return JSON.stringify(uncast(value, r("GeobodyBoundaryInterpretation")), null, 2);
    }
}
...
const typeMap: any = {
    "GeobodyBoundaryInterpretation": o([
    ...
    "Data": o([
        ...
        { json: "BoundaryRelationTypeID", js: "BoundaryRelationTypeID", typ: u(undefined, "") },
