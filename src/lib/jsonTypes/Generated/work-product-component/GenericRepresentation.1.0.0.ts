// To parse this data:
//
//   import { Convert, GenericRepresentation } from "./file";
//
//   const genericRepresentation = Convert.toGenericRepresentation(json);
//
...
export class Convert {
    public static toGenericRepresentation(json: string): GenericRepresentation {
        return cast(JSON.parse(json), r("GenericRepresentation"));
    }

    public static genericRepresentationToJson(value: GenericRepresentation): string {
        return JSON.stringify(uncast(value, r("GenericRepresentation")), null, 2);
    }
}
