// To parse this data:
//
//   import { Convert, UnstructuredGridRepresentation } from "./file";
//
//   const unstructuredGridRepresentation = Convert.toUnstructuredGridRepresentation(json);
//
...
export interface UnstructuredGridRepresentation {
     ...
     */
    createUser?: string;
    data?:       AbstractGridRepresentation;
    /**
...
export class Convert {
    public static toUnstructuredGridRepresentation(json: string): UnstructuredGridRepresentation {
        return cast(JSON.parse(json), r("UnstructuredGridRepresentation"));
    }

    public static unstructuredGridRepresentationToJson(value: UnstructuredGridRepresentation): string {
        return JSON.stringify(uncast(value, r("UnstructuredGridRepresentation")), null, 2);
    }
}
...
const typeMap: any = {
    "UnstructuredGridRepresentation": o([
        ...
        { json: "data", js: "data", typ: u(undefined, r("AbstractGridRepresentation")) },
    ...
    "AbstractGridRepresentation": o([
        ...
        { json: "CellShapeID", js: "CellShapeID", typ: u(undefined, "") },
        { json: "FaceCount", js: "FaceCount", typ: u(undefined, 0) },
        { json: "NodeCount", js: "NodeCount", typ: u(undefined, 0) },
