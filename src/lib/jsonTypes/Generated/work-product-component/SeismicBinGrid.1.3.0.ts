// To parse this data:
//
//   import { Convert, SeismicBinGrid } from "./file";
//
//   const seismicBinGrid = Convert.toSeismicBinGrid(json);
//
 ...
 */
export interface SeismicBinGrid {
    /**
...
export interface Data {
     ...
     */
    ABCDBinGridLocalCoordinates?: AbstractCoordinates[];
    /**
     ...
     * sets.
     */
    P6BinNodeIncrementOnIaxis?: number;
    /**
     ...
     * sets.
     */
    P6BinNodeIncrementOnJaxis?: number;
    /**
 ...
 */
export interface AbstractCoordinates {
    /**
...
export class Convert {
    public static toSeismicBinGrid(json: string): SeismicBinGrid {
        return cast(JSON.parse(json), r("SeismicBinGrid"));
    }

    public static seismicBinGridToJson(value: SeismicBinGrid): string {
        return JSON.stringify(uncast(value, r("SeismicBinGrid")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Data": o([
        ...
        { json: "ABCDBinGridLocalCoordinates", js: "ABCDBinGridLocalCoordinates", typ: u(undefined, a(r("AbstractCoordinates"))) },
        { json: "ABCDBinGridSpatialLocation", js: "ABCDBinGridSpatialLocation", typ: u(undefined, r("AbstractSpatialLocation")) },
        { json: "BinGridDefinitionMethodTypeID", js: "BinGridDefinitionMethodTypeID", typ: u(undefined, "") },
        { json: "BinGridName", js: "BinGridName", typ: u(undefined, "") },
        { json: "BinGridTypeID", js: "BinGridTypeID", typ: u(undefined, "") },
        { json: "CoveragePercent", js: "CoveragePercent", typ: u(undefined, 3.14) },
        { json: "P6BinGridOriginEasting", js: "P6BinGridOriginEasting", typ: u(undefined, 3.14) },
        { json: "P6BinGridOriginI", js: "P6BinGridOriginI", typ: u(undefined, 3.14) },
        { json: "P6BinGridOriginJ", js: "P6BinGridOriginJ", typ: u(undefined, 3.14) },
        { json: "P6BinGridOriginNorthing", js: "P6BinGridOriginNorthing", typ: u(undefined, 3.14) },
        { json: "P6BinNodeIncrementOnIaxis", js: "P6BinNodeIncrementOnIaxis", typ: u(undefined, 0) },
        { json: "P6BinNodeIncrementOnJaxis", js: "P6BinNodeIncrementOnJaxis", typ: u(undefined, 0) },
        { json: "P6BinWidthOnIaxis", js: "P6BinWidthOnIaxis", typ: u(undefined, 3.14) },
        { json: "P6BinWidthOnJaxis", js: "P6BinWidthOnJaxis", typ: u(undefined, 3.14) },
        { json: "P6MapGridBearingOfBinGridJaxis", js: "P6MapGridBearingOfBinGridJaxis", typ: u(undefined, 3.14) },
        { json: "P6ScaleFactorOfBinGrid", js: "P6ScaleFactorOfBinGrid", typ: u(undefined, 3.14) },
        { json: "P6TransformationMethod", js: "P6TransformationMethod", typ: u(undefined, 0) },
        { json: "SourceBinGridAppID", js: "SourceBinGridAppID", typ: u(undefined, "") },
        { json: "SourceBinGridID", js: "SourceBinGridID", typ: u(undefined, 0) },
        { json: "ExtensionProperties", js: "ExtensionProperties", typ: u(undefined, m("any")) },
    ], "any"),
    "AbstractCoordinates": o([
