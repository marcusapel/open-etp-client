// To parse this data:
//
//   import { Convert, GeobodyInterpretation } from "./file";
//
//   const geobodyInterpretation = Convert.toGeobodyInterpretation(json);
//
 ...
 */
export interface GeobodyInterpretation {
    /**
...
export class Convert {
    public static toGeobodyInterpretation(json: string): GeobodyInterpretation {
        return cast(JSON.parse(json), r("GeobodyInterpretation"));
    }

    public static geobodyInterpretationToJson(value: GeobodyInterpretation): string {
        return JSON.stringify(uncast(value, r("GeobodyInterpretation")), null, 2);
    }
}
