// To parse this data:
//
//   import { Convert, LocalModelCompoundCRS } from "./file";
//
//   const localModelCompoundCRS = Convert.toLocalModelCompoundCRS(json);
//
 ...
 * representations.
 */
export interface LocalModelCompoundCRS {
    /**
...
export class Convert {
    public static toLocalModelCompoundCRS(json: string): LocalModelCompoundCRS {
        return cast(JSON.parse(json), r("LocalModelCompoundCRS"));
    }

    public static localModelCompoundCRSToJson(value: LocalModelCompoundCRS): string {
        return JSON.stringify(uncast(value, r("LocalModelCompoundCRS")), null, 2);
    }
}
