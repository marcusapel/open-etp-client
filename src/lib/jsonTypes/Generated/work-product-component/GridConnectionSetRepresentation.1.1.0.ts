// To parse this data:
//
//   import { Convert, GridConnectionSetRepresentation } from "./file";
//
//   const gridConnectionSetRepresentation = Convert.toGridConnectionSetRepresentation(json);
//
...
export class Convert {
    public static toGridConnectionSetRepresentation(json: string): GridConnectionSetRepresentation {
        return cast(JSON.parse(json), r("GridConnectionSetRepresentation"));
    }

    public static gridConnectionSetRepresentationToJson(value: GridConnectionSetRepresentation): string {
        return JSON.stringify(uncast(value, r("GridConnectionSetRepresentation")), null, 2);
    }
}
...
const typeMap: any = {
    "GridConnectionSetRepresentation": o([
    ...
    "Data": o([
        ...
        { json: "ConnectionCount", js: "ConnectionCount", typ: u(undefined, 0) },
        { json: "GridRepresentationIDs", js: "GridRepresentationIDs", typ: u(undefined, a("")) },
        { json: "InterpretationIDs", js: "InterpretationIDs", typ: u(undefined, a("")) },
