/**
 * OSDU FluidBoundaryInterpretation work-product-component schema type definition.
 * Based on osdu:wks:work-product-component--FluidBoundaryInterpretation:1.2.0
...
/**
 * Properties for the FluidBoundaryInterpretation WPC record.
 */
export interface Data {
  ...
  /** The type of fluid contact (e.g. "free water contact", "gas oil contact", "gas water contact", "seal", "water oil contact"). */
  FluidContactTypeID?: string;
