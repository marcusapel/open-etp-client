// To parse this data:
//
//   import { Convert, TimeSeries } from "./file";
//
//   const timeSeries = Convert.toTimeSeries(json);
//
...
export class Convert {
    public static toTimeSeries(json: string): TimeSeries {
        return cast(JSON.parse(json), r("TimeSeries"));
    }

    public static timeSeriesToJson(value: TimeSeries): string {
        return JSON.stringify(uncast(value, r("TimeSeries")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Data": o([
        ...
        { json: "GeologicTimeValues", js: "GeologicTimeValues", typ: u(undefined, a(3.14)) },
        { json: "UTCDateTimeValues", js: "UTCDateTimeValues", typ: u(undefined, a("")) },
