// To parse this data:
//
//   import { Convert, StratigraphicUnitInterpretation } from "./file";
//
//   const stratigraphicUnitInterpretation = Convert.toStratigraphicUnitInterpretation(json);
//
...
export interface Data {
     ...
     */
    DepositionalEnvironmentID?: string;
    /**
     ...
     */
    DepositionalSubEnvironmentID?: string;
    /**
     ...
     */
    DepositionGeometryTypeID?: string;
    /**
     ...
     */
    StratigraphicRoleTypeID?: string;
...
export class Convert {
    public static toStratigraphicUnitInterpretation(json: string): StratigraphicUnitInterpretation {
        return cast(JSON.parse(json), r("StratigraphicUnitInterpretation"));
    }

    public static stratigraphicUnitInterpretationToJson(value: StratigraphicUnitInterpretation): string {
        return JSON.stringify(uncast(value, r("StratigraphicUnitInterpretation")), null, 2);
    }
}
...
const typeMap: any = {
    "StratigraphicUnitInterpretation": o([
    ...
    "Data": o([
        ...
        { json: "DepositionalEnvironmentID", js: "DepositionalEnvironmentID", typ: u(undefined, "") },
        { json: "DepositionalSubEnvironmentID", js: "DepositionalSubEnvironmentID", typ: u(undefined, "") },
        { json: "GeologicUnitShapeTypeID", js: "GeologicUnitShapeTypeID", typ: u(undefined, "") },
        { json: "IsIntrusive", js: "IsIntrusive", typ: u(undefined, true) },
        { json: "LithologyQualifierIDs", js: "LithologyQualifierIDs", typ: u(undefined, a("")) },
        { json: "LithologyTypeID", js: "LithologyTypeID", typ: u(undefined, "") },
        { json: "DomainTypeID", js: "DomainTypeID", typ: u(undefined, "") },
        { json: "FeatureID", js: "FeatureID", typ: u(undefined, "") },
        { json: "FeatureName", js: "FeatureName", typ: u(undefined, "") },
        { json: "MeanPossibleAge", js: "MeanPossibleAge", typ: u(undefined, 3.14) },
        { json: "OlderPossibleAge", js: "OlderPossibleAge", typ: u(undefined, 3.14) },
        { json: "YoungerPossibleAge", js: "YoungerPossibleAge", typ: u(undefined, 3.14) },
        { json: "ColumnStratigraphicHorizonBaseID", js: "ColumnStratigraphicHorizonBaseID", typ: u(undefined, "") },
        { json: "ColumnStratigraphicHorizonTopID", js: "ColumnStratigraphicHorizonTopID", typ: u(undefined, "") },
        { json: "DepositionGeometryTypeID", js: "DepositionGeometryTypeID", typ: u(undefined, "") },
        { json: "MaximumThickness", js: "MaximumThickness", typ: u(undefined, 3.14) },
        { json: "MinimumThickness", js: "MinimumThickness", typ: u(undefined, 3.14) },
        { json: "StratigraphicRoleTypeID", js: "StratigraphicRoleTypeID", typ: u(undefined, "") },
