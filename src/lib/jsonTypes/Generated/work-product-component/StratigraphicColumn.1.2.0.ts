// To parse this data:
//
//   import { Convert, StratigraphicColumn } from "./file";
//
//   const stratigraphicColumn = Convert.toStratigraphicColumn(json);
//
...
export interface Data {
     ...
     */
    StratigraphicColumnRankInterpretationSet?: string[];
    /**
     * Geographical area where a local stratigraphic column is valid: Basin, Region, Field,
     * Segment
     */
    StratigraphicColumnValidityAreaType?: string;
    /**
...
export class Convert {
    public static toStratigraphicColumn(json: string): StratigraphicColumn {
        return cast(JSON.parse(json), r("StratigraphicColumn"));
    }

    public static stratigraphicColumnToJson(value: StratigraphicColumn): string {
        return JSON.stringify(uncast(value, r("StratigraphicColumn")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Data": o([
        ...
        { json: "StratigraphicColumnRankInterpretationSet", js: "StratigraphicColumnRankInterpretationSet", typ: u(undefined, a("")) },
        { json: "StratigraphicColumnValidityAreaType", js: "StratigraphicColumnValidityAreaType", typ: u(undefined, "") },
        { json: "ValidationDate", js: "ValidationDate", typ: u(undefined, Date) },
        { json: "ValueChainStatusType", js: "ValueChainStatusType", typ: u(undefined, "") },
