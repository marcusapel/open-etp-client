// To parse this data:
//
//   import { Convert, PersistedCollection } from "./file";
//
//   const persistedCollection = Convert.toPersistedCollection(json);
//
...
export class Convert {
    public static toPersistedCollection(json: string): PersistedCollection {
        return cast(JSON.parse(json), r("PersistedCollection"));
    }

    public static persistedCollectionToJson(value: PersistedCollection): string {
        return JSON.stringify(uncast(value, r("PersistedCollection")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Data": o([
        ...
        { json: "HomogeneousMemberKind", js: "HomogeneousMemberKind", typ: u(undefined, "") },
        { json: "MemberIDs", js: "MemberIDs", typ: u(undefined, a("")) },
        { json: "ParentCollectionID", js: "ParentCollectionID", typ: u(undefined, "") },
        { json: "PurposeID", js: "PurposeID", typ: u(undefined, "") },
