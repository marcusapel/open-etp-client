// To parse this data:
//
//   import { Convert, EarthModelInterpretation } from "./file";
//
//   const earthModelInterpretation = Convert.toEarthModelInterpretation(json);
//
 ...
 */
export interface EarthModelInterpretation {
    /**
...
export interface Data {
     ...
     */
    GeologicUnitOccurrenceInterpretationIDs?: string[];
    /**
...
export class Convert {
    public static toEarthModelInterpretation(json: string): EarthModelInterpretation {
        return cast(JSON.parse(json), r("EarthModelInterpretation"));
    }

    public static earthModelInterpretationToJson(value: EarthModelInterpretation): string {
        return JSON.stringify(uncast(value, r("EarthModelInterpretation")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Data": o([
        ...
        { json: "GeologicUnitOccurrenceInterpretationIDs", js: "GeologicUnitOccurrenceInterpretationIDs", typ: u(undefined, a("")) },
        { json: "RockFluidOrganizationInterpretationIDs", js: "RockFluidOrganizationInterpretationIDs", typ: u(undefined, a("")) },
        { json: "StratigraphicColumnID", js: "StratigraphicColumnID", typ: u(undefined, "") },
        { json: "StructuralOrganizationInterpretationIDs", js: "StructuralOrganizationInterpretationIDs", typ: u(undefined, a("")) },
        { json: "WellboreCollectionIDs", js: "WellboreCollectionIDs", typ: u(undefined, a("")) },
