// To parse this data:
//
//   import { Convert, ColumnBasedTable } from "./file";
//
//   const columnBasedTable = Convert.toColumnBasedTable(json);
//
 ...
 */
export interface ColumnBasedTable {
    /**
...
export interface Data {
     ...
     */
    ColumnBasedTableTemplateID?: string;
    /**
     ...
     */
    Columns?: AbstractReferencePropertyType[];
    /**
     ...
     */
    KeyColumns?:          AbstractReferencePropertyType[];
 ...
 */
export interface AbstractReferencePropertyType {
    /**
...
export class Convert {
    public static toColumnBasedTable(json: string): ColumnBasedTable {
        return cast(JSON.parse(json), r("ColumnBasedTable"));
    }

    public static columnBasedTableToJson(value: ColumnBasedTable): string {
        return JSON.stringify(uncast(value, r("ColumnBasedTable")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Data": o([
        ...
        { json: "ColumnBasedTableTemplateID", js: "ColumnBasedTableTemplateID", typ: u(undefined, "") },
        { json: "ColumnBasedTableType", js: "ColumnBasedTableType", typ: u(undefined, "") },
        { json: "Columns", js: "Columns", typ: u(undefined, a(r("AbstractReferencePropertyType"))) },
        { json: "ColumnSize", js: "ColumnSize", typ: u(undefined, 0) },
        { json: "ColumnValues", js: "ColumnValues", typ: u(undefined, a(r("ColumnValues"))) },
        { json: "KeyColumns", js: "KeyColumns", typ: u(undefined, a(r("AbstractReferencePropertyType"))) },
    ...
    "ColumnValues": o([
        { json: "BooleanColumn", js: "BooleanColumn", typ: u(undefined, a(true)) },
        { json: "IntegerColumn", js: "IntegerColumn", typ: u(undefined, a(0)) },
        { json: "NumberColumn", js: "NumberColumn", typ: u(undefined, a(3.14)) },
        { json: "StringColumn", js: "StringColumn", typ: u(undefined, a("")) },
        { json: "UndefinedValueRows", js: "UndefinedValueRows", typ: u(undefined, a(0)) },
    ], "any"),
    "AbstractReferencePropertyType": o([
        { json: "ColumnName", js: "ColumnName", typ: u(undefined, "") },
        { json: "FacetIDs", js: "FacetIDs", typ: u(undefined, a(r("AbstractFacet"))) },
        { json: "PropertyType", js: "PropertyType", typ: u(undefined, r("AbstractPropertyType")) },
        { json: "RelationshipTargetKind", js: "RelationshipTargetKind", typ: u(undefined, "") },
        { json: "UnitOfMeasureID", js: "UnitOfMeasureID", typ: u(undefined, "") },
        { json: "UnitQuantityID", js: "UnitQuantityID", typ: u(undefined, "") },
        { json: "ValueCount", js: "ValueCount", typ: u(undefined, 0) },
        { json: "ValueType", js: "ValueType", typ: u(undefined, "") },
    ], "any"),
    "AbstractFacet": o([
        { json: "FacetRoleID", js: "FacetRoleID", typ: "" },
        { json: "FacetTypeID", js: "FacetTypeID", typ: "" },
    ], "any"),
