...
import { ManifestBuilder, ManifestOptions, Manifest } from "../../etp-client/src/manifest/builder";
...
async function main() {
  ...
  const outFile = path.resolve(__dirname, `../manifests/manifest_${instanceName}_${dataspace.replace("/", "_")}.json`);
