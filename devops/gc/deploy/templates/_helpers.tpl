...
{{- define "oetpClient.getAutoscaling" -}}
...
{{- define "oetpClient.minReplicasSpot" -}}
{{- $tier := include "oetpClient.getTier" . -}}
...
{{- define "oetpClient.maxReplicasSpot" -}}
{{- $tier := include "oetpClient.getTier" . -}}
